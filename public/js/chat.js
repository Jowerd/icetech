document.addEventListener('DOMContentLoaded', function() {
    ...
    const responses = {
        ...
        'საკონტაქტო': 'დაგვიკავშირდით ტელეფონით: 555-12-34-56 ან ელფოსტით: info@icetech.ge.',
        'ფასები': 'ფასების სანახავად გთხოვთ ეწვიოთ ჩვენს კატალოგს ან დაგვიკავშირდეთ დეტალური ინფორმაციისთვის.',
        'სამუშაო საათები': 'ჩვენ ვმუშაობთ ორშაბათიდან პარასკევის ჩათვლით, 10:00-დან 18:00 საათამდე.',
        ...
        'შეიძლება ნახვა ადგილზე?': 'დიახ, შეგიძლიათ ეწვიოთ ჩვენს ოფისს მისამართზე: ხაშური, ბორჯომის ქუჩა №2 და დაათვალიეროთ პროდუქცია ადგილზე.',
    ...
    function getAutoReply(userMessage) {
        ...
        if (lowerMessage.includes('ტელეფონი') || lowerMessage.includes('ნომერი') || lowerMessage.includes('დარეკვა')) {
            return 'დაგვიკავშირდით ნომერზე: 555-12-34-56';
        }
        
        if (lowerMessage.includes('მეილი') || lowerMessage.includes('ელფოსტა') || lowerMessage.includes('ელ-ფოსტა')) {
            return 'ჩვენი ელ-ფოსტა: info@example.ge';
        }
        
        // სტანდარტული პასუხი, თუ ვერცერთი თანხვედრა ვერ მოიძებნა
        return 'ბოდიში, ვერ გავიგე თქვენი შეკითხვა. გთხოვთ, დააზუსტოთ ან დაგვიკავშირდით 555-12-34-56 ნომერზე.';
    }
